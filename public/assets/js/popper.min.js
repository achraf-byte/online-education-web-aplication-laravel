...
! function(e, t) { "object" == typeof exports && "undefined" != typeof module ? t(exports) : "function" == typeof define && define.amd ? define(["exports"], t) : t((e = e || self).Popper = {}) }(this, (function(e) {
    ...
    function h(e) { return i(e) && "fixed" !== c(e).position ? e.offsetParent : null }
    ...
    function g(e) {
        ...
        if (!r) e: {
            for (e = d(e); i(e) && 0 > ["html", "body"].indexOf(a(e));) {
                if ("none" !== (r = c(e)).transform || "none" !== r.perspective || "auto" !== r.willChange) { r = e; break e }
                e = e.parentNode
            }
            r = null
        }
    ...
    function O() { for (var e = arguments.length, t = Array(e), n = 0; n < e; n++) t[n] = arguments[n]; return !t.some((function(e) { return !(e && "function" == typeof e.getBoundingClientRect) })) }
    ...
    function x(e) {
        ...
        return function(e, t, i) {
            ...
            return O(e, t) ? (p.setOptions(i).then((function(e) {!c && i.onFirstUpdate && i.onFirstUpdate(e) })), p) : p
        }
    }
    ...
    function E(e) { return e.replace(/left|right|bottom|top/g, (function(e) { return U[e] })) }

    function D(e) { return e.replace(/start|end/g, (function(e) { return z[e] })) }
    ...
    function k(e) { return Object.assign(Object.assign({}, e), {}, { left: e.x, top: e.y, right: e.x + e.width, bottom: e.y + e.height }) }
    ...
    function B(e, t, n) {
        ...
        }(e) : [].concat(t), (n = (n = [].concat(t, [n])).reduce((function(t, n) { return n = L(e, n), t.top = Math.max(n.top, t.top), t.right = Math.min(n.right, t.right), t.bottom = Math.min(n.bottom, t.bottom), t.left = Math.max(n.left, t.left), t }), L(e, n[0]))).width = n.right - n.left, n.height = n.bottom - n.top, n.x = n.left, n.y = n.top, n
    }

    function W(e) { return Object.assign(Object.assign({}, { top: 0, right: 0, bottom: 0, left: 0 }), e) }
    ...
    function H(e, n) {
        ...
        c = e.rects.popper, a = B(o(p = e.elements[p ? "popper" === i ? "reference" : "popper" : i]) ? p : p.contextElement || s(e.elements.popper), a, f), p = j({ reference: f = t(l), element: c, strategy: "absolute", placement: n }), c = k(Object.assign(Object.assign({}, c), p)), f = "popper" === i ? c : f;
        ...
        F = [{
            ...
            fn: function(e) {
                ...
                if (e = e.name, !t.modifiersData[e]._skip) {
                    ...
                    p = y(n = t.options.placement), i = i || (p !== n && l ? function(e) { if ("auto" === y(e)) return []; var t = E(e); return [D(e), t, D(t)] }(n) : [E(n)]);
                    var d = [n].concat(i).reduce((function(e, n) {
                        return e.concat("auto" === y(n) ? function(e, t) {
                            ...
                            var n = t.boundary,
                                ...
                                c = (f ? i ? S : S.filter((function(e) { return e.split("-")[1] === f })) : q).filter((function(e) { return 0 <= s.indexOf(e) })).reduce((function(t, i) { return t[i] = H(e, { placement: i, boundary: n, rootBoundary: r, padding: o })[y(i)], t }), {});
                    ...
                    for (var h = d[0], g = 0; g < d.length; g++) {
                        ...
                        if (O = x ? O ? "right" : "left" : O ? "bottom" : "top", n[w] > i[w] && (O = E(O)), w = E(O), x = [], r && x.push(0 >= j[v]), o && x.push(0 >= j[O], 0 >= j[w]), x.every((function(e) { return e }))) { h = b, p = !1; break }
                        m.set(b, x)
                    }
                    if (p)
